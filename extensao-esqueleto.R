...
sidra_1 = read.csv2("população residente estimada - UF e municípios - 2015 - SIDRA - tabela_6579.csv")
sidra_2 = read_excel("população residente censo 2010 - UF e municípios - total e por sexo - SIDRA - tabela_1552.xlsx")
sidra_3 = read_csv2("população residente censo 2010 - por faixa etária -  UF - SIDRA - tabela_1552.csv")
sidra_4 = read_csv2("população residente censo 2010 - por faixa etária e sexo -  municípios - SIDRA - tabela_1552.csv")

view(dados_sinasc_2)


sidra_12 = merge(sidra_1, sidra_2)
sidra_124 = merge(sidra_12, sidra_4)

sidra_final = bind_rows(sidra_3, sidra_124)


UF_SIDRA = substr(as.character(sidra_final$CODMUNRES), 1, 2)
sidra_tarefa = sidra_final[UF_SIDRA == "32",]
